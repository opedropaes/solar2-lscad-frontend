			...
			return ({
				...
				data: {
					averageIrradiations: {
						...
						lineTension: 0,
						label: 'Irradiação média sobre a mesa (W/m²)',
						backgroundColor: 'rgba(66,161,245,0)',
						borderColor: 'rgba(66,161,245,1.0)',
						pointBackgroundColor: 'rgba(66,161,245,1.0)',
						pointHoverRadius: 7
					...
					higherIrradiations: {
						...
						lineTension: 0,
						label: 'Picos de irradiação (W/m³)',
						backgroundColor: 'rgba(255,166,0,1.0)',
						borderColor: 'rgba(255,166,0,1.0)',
						pointBackgroundColor: 'rgba(255,166,0, 0.7)',
						pointHoverRadius: 7
					},
					averagesTemperatures: {
						data: res.averagesTemperatures,
						lineTension: 0,
						label: 'Temperatura média por dia (°C)',
						backgroundColor: 'rgba(66, 134, 244, 1.0)',
						borderColor: 'rgba(66, 134, 244, 1.0)',
						pointBackgroundColor: 'rgba(66, 134, 244, 0.7)',
						pointHoverRadius: 7
					...
					higherTemperatures: {
						...
						lineTension: 0,
						label: 'Maiores temperaturas por dia (°C)',
						backgroundColor: 'rgba(50,172,92, 1.0)',
						borderColor: 'rgba(50,172,92, 1.0)',
						pointBackgroundColor: 'rgba(50,172,92, 0.7)',
						pointHoverRadius: 7
					...
					lowerTemperatures: {
						...
						lineTension: 0,
						label: 'Menores temperaturas por dia (°C)',
						backgroundColor: 'rgba(255,48,48, 1.0)',
						borderColor: 'rgba(255,48,48, 1.0)',
						pointBackgroundColor: 'rgba(255,48,48, 0.7)',
						pointHoverRadius: 7
					...
					averageWindSpeeds: {
						...
						lineTension: 0,
						label: 'Velocidade do vento média (km/h)',
						backgroundColor: 'rgba(255,166,0,0)',
						borderColor: 'rgba(255,166,0,1.0)',
						pointBackgroundColor: 'rgba(255,166,0, 0.7)',
						pointHoverRadius: 7
					...
					accumulatePM1: {
						...
						lineTension: 0,
						label: 'Particulados PM1 acumulados (μg/m³)',
						backgroundColor: 'rgba(255,166,0,0)',
						borderColor: 'rgba(255,166,0,1.0)',
						pointBackgroundColor: 'rgba(255,166,0, 0.7)',
						pointHoverRadius: 7
					...
					averagesPM1: {
						...
						lineTension: 0,
						label: 'Média de particulados PM1 (μg/m³)',
						backgroundColor: 'rgba(255,166,0,0)',
						borderColor: 'rgba(255,166,0,1.0)',
						pointBackgroundColor: 'rgba(255,166,0, 0.7)',
						pointHoverRadius: 7
					...
					accumulatePM2: {
						...
						lineTension: 0,
						label: 'Particulados PM2 acumulados (μg/m³)',
						backgroundColor: 'rgba(255,166,0,0)',
						borderColor: 'rgba(255,166,0,1.0)',
						pointBackgroundColor: 'rgba(255,166,0, 0.7)',
						pointHoverRadius: 7
					...
					averagesPM2: {
						...
						lineTension: 0,
						label: 'Média de particulados PM2 (μg/m³)',
						backgroundColor: 'rgba(255,166,0,0)',
						borderColor: 'rgba(255,166,0,1.0)',
						pointBackgroundColor: 'rgba(255,166,0, 0.7)',
						pointHoverRadius: 7
							...
							<div className="col-11 mx-auto">
								<main className="col-lg-12 mx-auto p-0" role="main" id="main">
									...
									<div className="row m-4 px-0 py-0" id="row-chart">
										...
										<div className="col-md-6 container-fluid pb-3 pt-0 py-0 mx-auto my-auto" id="canvas-container-2">
											<BarChart
												data={{ labels: this.state.labels, datasets: [this.state.data.averagesTemperatures, this.state.data.higherTemperatures, this.state.data.lowerTemperatures] }}
												options={this.state.options}
											/>
										</div>
										<div className="col-md-6 container-fluid pb-3 pt-0 py-0 mx-auto my-auto" id="canvas-container-3">
										...
										<div className="col-md-6 container-fluid pb-3 pt-0 py-0 mx-auto my-auto" id="canvas-container-5">
											<BarChart
												data={{ labels: this.state.labels, datasets: [this.state.data.accumulatePM1, this.state.data.averagesPM1] }}
												options={this.state.options}
											/>
										</div>
										<div className="col-md-6 container-fluid pb-3 pt-0 py-0 mx-auto my-auto" id="canvas-container-6">
											<BarChart
												data={{ labels: this.state.labels, datasets: [this.state.data.accumulatePM2, this.state.data.averagesPM2] }}
												options={this.state.options}
											/>
										</div>
									</div>
